# -*- coding: utf-8 -*-
"""
Created on Tue Dec 11 21:30:28 2018
...
def main():
    #初回のみ実行要
    CSV = readCSVs()
    pickle.dump(CSV, open(r'./data/usd_jpy_2017_protocol2.pkl', 'wb'), protocol=0)
    
    #バイト配列に変換されたcsvファイルを読み込む
    CSV1 = calcTime(lambda: pickle.load(open(r'./data/usd_jpy_2017_protocol2.pkl', 'rb')))
    print('pickleのプロトコルバージョン2で読み込むと{}秒かかりました。'.format(CSV1['time']))
